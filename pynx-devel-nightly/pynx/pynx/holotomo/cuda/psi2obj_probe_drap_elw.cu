...
*/
__device__ float Psi2ObjProbeDRAP(const int i, complexf* obj, complexf* obj_old, complexf* probe,
...
* This version assumes the probe is different for each z (propagation distances)
*/
__device__ void Psi2ProbeDRAP(const int i, complexf* obj, complexf* probe,
                              complexf* psi, complexf* psiold,
