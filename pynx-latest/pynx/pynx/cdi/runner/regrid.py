...
class Regrid3D(OpenclProcessing):
    ...
    def send_image(self, image, slice_=None):
        ...
        :param slice_: slice object with the start and end of the buffer to be copied
        :return: Nothing
        """
    ...
    def project_one_frame(self, frame,
        ...
        :param oversampling_img: Each pixel will be split in n x n and projected that many times
        :param oversampling_rot: project multiple times each image between rot-d_rot/2 and rot+d_rot/2
        :return: None
        """
