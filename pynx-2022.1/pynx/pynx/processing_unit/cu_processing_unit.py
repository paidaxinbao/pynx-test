...
from .cuda_device import cu_drv, cua, has_cuda, has_vkfft_cuda, has_skcuda, VkFFTApp, cu_fft
...
class CUProcessingUnit(ProcessingUnit):
    ...
    def cu_fft_get_plan(self, cu_data, ndim=None, stream=None, dtype_dest=None, dtype_src=None,
        ...
        if self.use_vkfft:
            ...
            # Forward and backward R2C require each a different plan
            k = (fft_shape, dtype_src, dtype_dest, ndim, stream)
